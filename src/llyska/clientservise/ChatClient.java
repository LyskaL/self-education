...
public class ChatClient {
     ...
     * @throws java.io.IOException - если не смогли приконнектиться, кидается исключение, чтобы предотвратить создание
     *         объекта
     */
    ...
    /**
     * метод закрывает коннект и выходит из программы (это единственный выход прервать работу BufferedReader.readLine(),
     * на ожидании пользователя)
     */
